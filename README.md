...
**WARNING: Using the master branch will install CONSUL's current master branch. To install the latest stable version, use [release 1.2.0](https://github.com/consul/installer/tree/1.2.0).**
